...
- Ensayo Determinacion de Humedad (MoistureContent, MC Vol.8 §8.102.2) : implementado 12-ago-2026, pendiente de commit. Registro plano (sin sub-modelo de puntos), mismo patron que ParticleDensity. Diseñado explicitamente para ser referenciado por FK opcional desde ensayos futuros -- Cono de Arena (siguiente en la cola) sera el primero en consumirlo via moistureContentId.
